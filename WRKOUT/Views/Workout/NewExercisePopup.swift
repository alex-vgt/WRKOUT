...
struct NewExercisePopup: UIViewControllerRepresentable {
    @Binding var textString: String
    @Binding var showAlert: Bool
    
    var title: String
    var message: String
    var overview: WorkoutView
    ...
    func makeUIViewController(context: UIViewControllerRepresentableContext<NewExercisePopup>) -> UIViewController {
         return UIViewController() // Container on which UIAlertContoller presents
    }
    
    func updateUIViewController(_ uiViewController: UIViewController, context: UIViewControllerRepresentableContext<NewExercisePopup>) {
        ...
        if self.showAlert {
            ...
            alert.addAction(UIAlertAction(title: NSLocalizedString("Save", comment: ""), style: .default) { _ in
                ...
                if let textField = alert.textFields?.first, let text = textField.text {
                    overview.saveNewExercise(exerciseName: text)
    ...
    func makeCoordinator() -> NewExercisePopup.Coordinator {
      Coordinator(self)
    }
    ...
    class Coordinator: NSObject, UITextFieldDelegate {
      ...
      var control: NewExercisePopup
      
      init(_ control: NewExercisePopup) {
